...
public class InstagramPhotoAdapter extends ArrayAdapter<InstagramPhoto> {
	...
	private OnClickListener getDialogOnClickListener(
		...
		return new OnClickListener() {
			...
			public void onClick(View view) {
				CommentsDialog.getDialog(view.getContext(), comments).show();
			}
		};
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView imgProfile = (ImageView) convertView
				.findViewById(R.id.imgProfilePhoto);

		String captionHtml = String
				.format("<b> <span style='color:#6666FF'>%s</span></b>&nbsp;<span>%s</span>",
						photo.user.userName, photo.caption);
